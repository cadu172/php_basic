...
<html lang="pt-br">
	...
	<h3>AULA 14 - Exercício 1 { FUNCTIONS } :: FUNCAO COM RETORNO</h3>
	<fieldset>
	<p>
	...
	if ( isset($_POST["BtnCalcular"]) ) {
		...
		// executa a soma
		echo "O Resultado da Soma entre $numeroA + $numeroB => " . somarNumero($numeroA,$numeroB);
